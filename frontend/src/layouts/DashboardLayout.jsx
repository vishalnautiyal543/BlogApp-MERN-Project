...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-darkmode flex flex-col w-full text-gray-900 overflow-y-auto">
      {/* --- MOBILE TOP BAR --- */}
        ...
        <main className="flex-1 w-full min-h-0 md:pl-64 block pt-4 px-4 md:pt-8 md:px-8">
          <div className="w-full max-w-7xl mx-auto">
            <Link to="/" className="mb-4 inline-block">
              <button className="bg-primary font-Inter text-white ml-4 py-1 px-4 rounded-full cursor-pointer hover:bg-primary/80">
                Go to Home
              </button>
            </Link>
            <Outlet />
